			...
			<div id="gallery">
				...
				<ul>
					<c:forEach items='${list }' var='gallery' varStatus='status'>
						<li><a
							href="${pageContext.request.contextPath }${gallery.url}"
							data-lightbox="gallery" class="image"
							style="background-image:url('${pageContext.request.contextPath }${gallery.url }')">&nbsp;</a>

							<c:if test="${not empty authUser && authUser.role == 'ADMIN' }">
								<a
									style="background: url('${pageContext.request.contextPath }/assets/images/delete-image.png') no-repeat 0 0 / 18px"
									href="${pageContext.request.contextPath }/gallery/delete/${gallery.no }"
